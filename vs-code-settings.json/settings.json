{
  ...
  "editor.fontFamily": "'JetBrainsMono NF','Iosevka', 'Hack Nerd Font Mono', 'Fira Code iScript', 'JetBrainsMono Nerd Font', monospace, 'Droid Sans Fallback'",
  ...
  "dateTime.customFormat": "ddd, MM-DD-YY, hh:mm A ",
  ...
  "editor.scrollbar.verticalScrollbarSize": 0, //minimap inside scrollbar
  "workbench.activityBar.visible": false, //the side bar
  ...
  "prettier.semi": true,
  // "editor.glyphMargin": false, //margin on the left side of line numbers
